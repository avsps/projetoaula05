...
namespace ProjetoAula05.Controllers
{
    ...
    {
        //atributo privado..
        private string connectionString = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=BDAula05;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
